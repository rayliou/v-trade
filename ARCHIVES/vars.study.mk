...
BIG_TABLE_MERGED_FILE_CN=/Users/henry/stock/v-trade/data/data_study/stk-daily-20220125.cn.Yahoo.1m.csv

#BT_DATA_SOURCE=/Users/henry/stock/v-trade/data/data_study/stk-daily-20220113.$(GROUP).Yahoo.30s.csv
END_DATES_LIST=$(shell $(PY_PATH)/pairs_trading/studyCointegrate.py date-list-from-bigcsv  --skipdays 42  $(BIG_TABLE_MERGED_FILE_CN) )
