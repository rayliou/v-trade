...
class SmaCross(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.vwap_ = VWAP()
        self.last_value_ = 0
        self.adx_ = bt.ind.AverageDirectionalMovementIndex()
    ...
    def next(self):
        print(f'ADX:{self.adx_[0]}, {self.adx_[-1]}')
        self.cnt_ += 1
        ...
        elif (self.dataclose[0] + 1.3 *self.atr5_ < self.last_high_ and ema_vol_ratio > 1.3) \
          or self.dataclose[0] + 4.8 *self.atr20_ < self.last_high_:
