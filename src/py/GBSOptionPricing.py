...
def american_76(option_type, fs, x, t, r, v): # Commodities
def amer_implied_vol(option_type, fs, x, t, r, q, cp):
def amer_implied_vol_76(option_type, fs, x, t, r, cp):


def kirks_76(option_type, f1, f2, x, t, r, v1, v2, corr): # Spread Option formula
...
def merton(option_type, fs, x, t, r, q, v): # Merton Model: Stocks Index, stocks with a continuous dividend yields
def black_76(option_type, fs, x, t, r, v): # Commodities
def garman_kohlhagen(option_type, fs, x, t, r, rf, v): # FX Options
def asian_76(option_type, fs, x, t, t_a, r, v): # Average Price option on commodities
...
def _debug(debug_input):
    if (__name__ == "__main__") and (_DEBUG is True):
        print(debug_input)
...
american('p', 653.38 ,655, 1/12.0, 0.01, 0, 0.52778)
amer_implied_vol('p', 653.38 ,655, 1/12.0, 0.01, 0, 41)
